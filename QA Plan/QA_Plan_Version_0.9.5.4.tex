...
\begin{flushleft}
\begin{tabular}[H]{|m{1.5cm}|m{6,5cm}|m{1,25cm}|m{2cm}|m{2,5cm}|}
\hline
\rowcolor{myblue}
...
The software development life-cycle of the OpenETCS project has to comply with CEN50128. Requirements imposed by the standard are analyzed and shown in detail in D2.2. The software development life-cycle is described in Deliverable 2.3 and D2.X.

\subsubsection{Life Cycle of the OpenETCS Tools chain}
The development of the Tool Chain has to comply with EN50128. Requirements imposed by the standard are analyzed and shown in detail in D2.2. The software development life-cycle is described in Deliverable 7.XXXX.
...
\tablefirsthead{\hline
\rowcolor{myblue}
\multicolumn{5}{|c|}{Documentation Structure within the development process of the openETCS Software}\\
\hline \rowcolor{lightgray} \centering Phase & \centering SIL4 & \centering Document & \centering WP/Task & Document\\}
\tablehead{\hline
\rowcolor{myblue}
\multicolumn{5}{|c|}{Software Requirements Specification Phase}\\}
\begin{supertabular}[H]{|m{2cm}|m{1cm}|m{7cm}|m{2cm}|m{2cm}|}
\hline
Planning &
\centering HR &
\raggedright
