...
%\FIXME{The semi-formal reference specification is actually out of scope. Feedback needed here.}
...
%%%Deleting the part with the description of SCRUM and transfer it to D2.3b
...
\begin{table}[H]
 \begin{center}
	\tablefirsthead{\hline
		\rowcolor{myblue}
		\multicolumn{2}{|c|}{Software Specification Phase}\\ \hline
		 \rowcolor{lightgray}
		  \centering  & \\}
	\tablehead{\\}
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{Software Design Phase}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{\\}
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{SW Component Implementation and Test Phase}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{\\}
		\begin{supertabular}[H]{|p{6cm}|p{8cm}|}
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{Software Integration Phase}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{\hline
			\rowcolor{myblue}
			\multicolumn{5}{|c|}{Software Integration Phase}\\}
		\begin{supertabular}[H]{|p{6cm}|p{8cm}|}
			\hline
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{Software Validation Phase}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{\hline
			\rowcolor{myblue}
			\multicolumn{5}{|c|}{Software Validation Phase}\\}
		\begin{supertabular}[H]{|p{6cm}|p{8cm}|}
			\hline
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{openETCS Tools and Tool Chain Software Requirements}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{\\}
		\begin{supertabular}[H]{|p{6cm}|p{8cm}|}
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{openETCS Development Planning}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{\hline
			\rowcolor{myblue}
			\multicolumn{5}{|c|}{openETCS Development Planning}\\}
		\begin{supertabular}[H]{|p{6cm}|p{8cm}|}
			\hline
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{openETCS Tool Chain Test Plan}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{\hline
			\rowcolor{myblue}
			\multicolumn{5}{|c|}{openETCS Tool Chain Test Plan}\\}
		\begin{supertabular}[H]{|p{6cm}|p{8cm}|}
			\hline
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{openETCS Tool Chain Architecture and Design}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{\hline
			%\rowcolor{myblue}
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{openETCS Tool Chain Components Selections}\\ \hline
			\rowcolor{lightgray}
			  & \\}
		\tablehead{\hline
			%\rowcolor{myblue}
			%\multicolumn{5}{|c|}{openETCS Tool Chain Components Selections}\\
			}
		\begin{supertabular}[H]{|p{6cm}|p{8cm}|}
			\hline
...
\begin{table}[H]
	\begin{center}	
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{openETCS Tool Chain Components Integration}\\ \hline
			\rowcolor{lightgray}
			  & \\}
		\tablehead{\hline
			%\rowcolor{myblue}
...
\begin{table}[H]
	\begin{center}
		...
		\tablehead{\hline
			\rowcolor{myblue}
			\multicolumn{5}{|c|}{openETCS Tool Chain Components Integration}\\}
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{openETCS Tool Chain Component Test}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{\hline
			\rowcolor{myblue}
			\multicolumn{5}{|c|}{openETCS Tool Chain Component Test}\\}
		\begin{supertabular}[H]{|p{6cm}|p{8cm}|}
			\hline
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{openETCS Tool Chain Test}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{%\hline
			%\rowcolor{myblue}
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{openETCS Tool Chain Maintenance}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{\hline
			\rowcolor{myblue}
			\multicolumn{5}{|c|}{openETCS Tool Chain Maintenance}\\}
		\begin{supertabular}[H]{|p{6cm}|p{8cm}|}
			\hline
...
\begin{table}[H]
	\begin{center}
		\tablefirsthead{\hline
			\rowcolor{myblue}
			\multicolumn{2}{|c|}{openETCS Tool Chain Documentation}\\ \hline
			\rowcolor{lightgray}
			\centering  & \\}
		\tablehead{\hline
			\rowcolor{myblue}
			\multicolumn{5}{|c|}{openETCS Tool Chain Documentation}\\}
		\begin{supertabular}[H]{|p{6cm}|p{8cm}|}
			\hline
			Responsible &
			WP7 \\
...
\centering \gls{HR} &
System Specification Model (D3.5)

Functional Model (D3.6)

System Architecture Model with physical allocation (D3.7)-Alstom-

Data Dictionary -Bernd Hekele-

Data Dictionary Design Specification - Cecile Braunstein-

Internal Data Structure -Jan Welvaarts-

Data Dictionary Data Catalog -Bernd Hekele-

Data Model Description -Marielle Petit Doche-

openETCS API Document -Alstom-(D2.7)

openETCS SSRS Interface Document

EVC External Interfaces-Baseliyos Jacob-

SRS analysis and functions -Bernd Hekele-
...
\centering \gls{HR} &
1st V\&V report on model (D4.2.1)

1st V\&V report on implementation/ code (D4.2.2)
...
\centering \gls{HR} &
D7.1 Report on the Final Choice of the Primary Tool Chain
...
\hline \rowcolor{lightgray}
 \centering
  ...
  \centering
   ...
   SIL 4 & 
   \centering 
   Applied (Yes/No) & Details and References \\}
\tablehead{\hline
\rowcolor{myblue}
\multicolumn{5}{|c|}{Software Requirements Specification Phase}\\}
...
\rowcolor{lightgray}
\multicolumn{5}{|p{16cm}|}{Justification: \textbf{(To be fulfilled)}}\\\hline
\multicolumn{5}{|p{16cm}|}{Due to the agile work in openETCS via github maintenance is performed during every iteration and controlled via standard change control.}\\\hline
\end{longtable}
\end{center}
