...
\begin{description}
\item \textbf{Tool chain Requirements}
...
\item \textbf{Tool chain Architecture and Design}
...
\underline{\textit{Tasks}}
\begin{itemize}
\item Definition of how the tool chain is implemented including the definition of the interoperability mechanism
\end{itemize}

\item \textbf{Tool chain Components Selections}
...
\underline{\textit{Outputs}}
\begin{itemize}
\item Primary Tool chain Evaluation: Evaluation of the models and tools against the WP2 requirements
\item Primary Tool chain Evaluation: Evaluation of the tool platform against the WP2
requirements
...
\item \textbf{Tool chain Components Implementation and Testing}

\underline{\textit{Inputs}}
\begin{itemize}
\item \textcolor{red}{Test and Verification Plan}
\end{itemize}
...
\item Tool chain Components Test Report
\end{itemize}

\underline{\textit{Tasks}}
\begin{itemize}
\item Implementation of the tool chain in particular for the need of tool interoperability
...
\item \textbf{Tool chain Validation}
...
\underline{\textit{Outputs}}
\begin{itemize}
\item Tool chain Validation Reports
\item Tool chain guidelines
\end{itemize}

\underline{\textit{Tasks}}
\begin{itemize}
\item Elaborate guidelines on how to use the tool chain in an agile development
\end{itemize}
...
\textcolor{red}{Requirements Modeling for SSRS Activities with ProR -Michael Jastram-}

\textcolor{red}{Tool chain Design Specification- Cecile Braunstein and Jan Peleska-}
