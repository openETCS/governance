...
\rowcolor{lightgray}
\multicolumn{5}{|l|}{Justification: \textbf{(To be fulfilled)}}\\\hline
\multicolumn{5}{|l|}{The openETCS methodology covers at least in parts all relevant verification techniques. Due to the geniric concept of openETCS hardware related tests are not part of openETCS. Several tests will only be implemented on parts of the systems as a proof of concept. }\\\hline
\end{longtable}
\end{center}
